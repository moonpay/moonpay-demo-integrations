...
2.) If running locally, set up your integration on a port. 
    To do this:
...
3.) To view your integration, navigate to 'http://localhost:8080' in your browser
4.) If moving to production, along with switching to live API keys and "environment:" to "production" in index.js, make sure that the URL in line 55 of index.js is set to buy.moonpay.com instead of buy-sandbox.moonpay.com
5.) Allow-list your production domain on dashboard.moonpay.com/developers
